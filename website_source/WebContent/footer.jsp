		...
		<div class="container">
			...
			<div class="row">
				<div class="col item social">
					<a class="border rounded-circle border-danger"
						href="https://it-it.facebook.com/rosario.gagliardi"
						style="background-color: #a3140e;"><i
						class="icon ion-social-facebook"></i></a><a
						class="border rounded-circle border-danger"
						href="https://it.linkedin.com/in/francescoabateimtech?trk=people-guest_profile-result-card_result-card_full-click"
						style="background-color: #a3140e;"><i
						class="icon ion-social-twitter"></i></a> <a
						class="border rounded-circle border-danger" href="#"
						style="background-color: #a3140e;"><i
						class="icon ion-social-snapchat"></i></a><a
						class="border rounded-circle border-warning"
						href="https://www.instagram.com/marco_production/?hl=it"
						style="background-color: #a3140e;"><i
