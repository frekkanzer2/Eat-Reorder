...
<body>
	...
	<div class="center-block">
		...
		<form class="custom-border-red partial-container-form-floating login-form-style" method="POST" action="DoInserimentoProdotto"onsubmit="return checkProdotto();">
			...
			<input class="custom-border-red border-rounded-small form-control input-style-login"id="nome"type="text"name="nome"placeholder="Nome del piatto">
			...
			<input class="custom-border-red border-rounded-small form-control input-style-login"id="prezzo"type="text"name="costo"placeholder="Prezzo del piatto">
            ...
            <input class="custom-border-red border-rounded-small form-control input-style-login"id="img"type="text"name="img_path"placeholder="URL dell'immagine da caricare">
