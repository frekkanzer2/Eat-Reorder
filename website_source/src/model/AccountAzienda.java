...
public class AccountAzienda extends AccountUtenteRegistrato{
	...
	private Map<Long,Prodotto> prodotti = new HashMap<Long,Prodotto>();

	
	public AccountAzienda(String email, String password, String tipo, String nome, String via, int numeroCivico, String citta,
	...
	public void modificaDati(AccountAzienda newAccountInforma) {
		
	}
	
	
	public Prodotto dammiProdotto(Long id) {
